...
Usage:
    python3 tools/gen_firefly_can_config.py [--base-node-id 30] [--out obj]
...
def main() -> None:
    ...
    ap.add_argument("--base-node-id", type=int, default=30,
                    help="node ID for motor 1; motors 2-4 use +1..+3 (default 30)")
